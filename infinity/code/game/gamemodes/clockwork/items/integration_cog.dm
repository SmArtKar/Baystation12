...
/obj/item/weapon/clockwork/integration_cog
...
/obj/item/weapon/clockwork/integration_cog/Destroy()
	STOP_PROCESSING(SSfastprocess, src)
	. = ..()

/obj/item/weapon/clockwork/integration_cog/Process()
	if(!apc)
		...
		var/obj/item/weapon/stock_parts/power/battery/bat = apc.get_component_of_type(/obj/item/weapon/stock_parts/power/battery)
		var/obj/item/weapon/cell/cell = bat.cell
...
/obj/structure/window/basic/full/clockwork
	icon = 'clockwork_sprites/clockwork_window.dmi'
	color = "#ffffff"